...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CommunityKVPair) DeepCopyInto(out *CommunityKVPair) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CommunityKVPair.
func (in *CommunityKVPair) DeepCopy() *CommunityKVPair {
	if in == nil {
		return nil
	}
	out := new(CommunityKVPair)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrefixAdvertisements) DeepCopyInto(out *PrefixAdvertisements) {
	*out = *in
	if in.Communities != nil {
		in, out := &in.Communities, &out.Communities
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrefixAdvertisements.
func (in *PrefixAdvertisements) DeepCopy() *PrefixAdvertisements {
	if in == nil {
		return nil
	}
	out := new(PrefixAdvertisements)
	in.DeepCopyInto(out)
	return out
}
